...
def save_output_figure(title: str) -> None:
    ...
    :return: None
    """
    plt.savefig(r"D:\My Document\DA1\Dataset\Mini MIAS\Breast-Cancer-Detection-Mammogram-Deep-Learning-master\Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication\output\{}_dataset-{}_mammogramtype-{}_model-{}_lr-{}_b-{}_e1-{}_e2-{}_roi-{}_{}_{}.png".format(
            config.run_mode,
            config.dataset,
...
def load_trained_model() -> None:
    ...
    return load_model(r"D:\My Document\DA1\Dataset\Mini MIAS\Breast-Cancer-Detection-Mammogram-Deep-Learning-master\Breast-Cancer-Detection-Mammogram-Deep-Learning-Publication\saved_models\dataset-{}_mammogramtype-{}_model-{}_lr-{}_b-{}_e1-{}_e2-{}_roi-{}_{}_saved-model.h5".format(
            config.dataset,
            config.mammogram_type,
            config.model[0:],
            config.learning_rate,
